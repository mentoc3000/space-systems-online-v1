...
function spacecraft(spacecraftData) {
   ...
   if (spacecraftData & 
      ...
      spacecraftData.mission.initial.epoch.DateFormat) {
   ...
   if (spacecraftData & 
      ...
      spacecraftData.mission.initial & 
      spacecraftData.mission.initial.epoch & 
      spacecraftData.mission.initial.epoch.Epoch) {
   ...
   if (spacecraftData & 
      spacecraftData.mission & 
      spacecraftData.mission.initial &
      spacecraftData.mission.initial.oribt &
      spacecraftData.mission.initial.orbit.X) {
